...
model.info = read.csv("/brachi/model_info.txt", sep = "\t")
...
ratios.2.calculate = read.csv("/brachi/BLUPs/ratios_to_calculate.csv", h = T)
...
write.table(blups.ratios[,2:ncol(blups.ratios)], "/brachi/BLUPs/dat_tot_ratios_forGemma.csv",
...
write.table(dat.predict, "/brachi/BLUPs/dat_tot_original_scale.csv",
